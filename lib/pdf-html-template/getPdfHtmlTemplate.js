...
export const getMedicationErrorReportHtmlByFields = (data, headerTitle) => {
    ...
    const reports = data.map((row) =>
        row.error_type
            ? {
                ...row,
                error_type_name: row.error_type?.name === "Others"
            ...
            .map(
                (row, i) => `
                    ...
                    "MMM. DD, YYYY"
                                        ...
                                        <td>${row.incident_description || ""
                    }</td>
                                        <td>${row.workplace_environment || ""
                    }</td>
                                        <td>${row.immediate_actions || ""}</td>
                                        <td>${row.corrective_actions || ""}</td>
                                        <td>${row.preventive_actions || ""}</td>
                                        <td>${row.error_type.is_medicine_needed &&
