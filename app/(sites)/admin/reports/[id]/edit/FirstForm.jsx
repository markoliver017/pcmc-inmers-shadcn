...
import FormLabel from "@/(sites)/(client)/FormLabel";
import { ArrowLeft, Calendar, Cross, X } from "lucide-react";
...
export default function FirstForm({ onNext }) {
        ...
        <section className="flex-1 h-full flex flex-col">
            <div className="flex-1">
                <div className="flex flex-wrap sm:gap-5">
                    <h2 className="card-title text-2xl">
                        ...
                        <small className="text-gray-700 dark:text-blue-200 italic">
                            ID ({watch("id")})
                        </small>
                    </h2>
            ...
            <div className="flex-none card-actions justify-between mt-5">
                <button
                    ...
                    tabIndex="6"
                >
                    <X /> <span className="hidden sm:inline-block">Cancel</span>
                </button>
                <button
                    type="button"
